    ...
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <div className="my-16 text-center animate-fade-in">
        <h2 className="text-sm text-zinc-500 ">
          {'Copyright © '}
          {currentYear} {' '}
          <Link className="link text-[#848580] hover:text-white underline" href="https://codeflict.com/" title="Codeflict">
            Codeflict
          </Link>
          {' '} - All right reserved
        </h2>
        <div className="flex items-center justify-center mt-4 gap-4">
          <Link className="text-[#848580] hover:text-white underline" href="https://www.instagram.com/codeflict/" title="Codeflict Instagram">
          ...
          <Link className="text-[#848580] hover:text-white underline" href="https://www.linkedin.com/company/codeflict" title="Codeflict LinkedIn">
