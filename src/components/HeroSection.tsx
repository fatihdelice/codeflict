  ...
  return (
    <div className="relative ml-auto">
      <div className="mx-auto">
        ...
        <p className="mt-8 text-gray-700 dark:text-gray-300">At Codeflict, we are dedicated to shaping a world through reimagination and innovation. We are a comprehensive platform for all things related to software development, web development, and mobile application development. We provide in-depth reviews of the latest technologies and offer practical tips to enhance your coding skills.</p>
